// sw-omsi.js
const CACHE_NAME = 'omsi-tools-cache-v1'; // NEW cache name
const urlsToCache = [
  ...
  '/live-tracker/manifest-omsitools.json', // Cache the manifest
  ...
  '/live-tracker/assets/icons/icon-192x192.png', // One of your icons
